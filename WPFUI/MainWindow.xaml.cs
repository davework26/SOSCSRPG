...
namespace WPFUI
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow(Player player, int xLocation = 0, int yLocation = 0)
        {
            ...
            SetActiveGamesSessionTo(new GameSession(player, xLocation, yLocation));
        }
        ...
        private void SetActiveGamesSessionTo(GameSession gameSession)
        {
        ...
        {
            // Bug: adds a battle event on every new game. 
        ...
        private void AskToSaveGame()
        {
            ...
            // Centre yesnowwindow on current window.
